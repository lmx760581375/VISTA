...
model=llava-v1.5-7b-autoregressive-lossweight-bsx2
save_attention_path=attention_visualization/${model}
# save_attention_path=visualization_compare/${model}
...
answer_file=${save_root}/${model_name}_pope_coco_${pope_subset}_test.jsonl
